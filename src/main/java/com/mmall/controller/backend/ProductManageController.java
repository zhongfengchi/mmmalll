...
public class ProductManageController {
    ...
    @ResponseBody
    public Map richtextImageUpload(HttpSession session, @RequestParam(value="richtext_file",required = false) MultipartFile multipartFile, HttpServletRequest request, HttpServletResponse response){
        Map map = Maps.newHashMap();
        User user = (User) session.getAttribute(Const.CURRENT_USER);
        if (user == null) {
